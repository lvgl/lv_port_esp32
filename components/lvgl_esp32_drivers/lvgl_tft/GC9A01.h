 ...
 *      DEFINES
 *********************/
#define GC9A01_DC   CONFIG_LVGL_DISP_PIN_DC
#define GC9A01_RST  CONFIG_LVGL_DISP_PIN_RST
#define GC9A01_BCKL CONFIG_LVGL_DISP_PIN_BCKL

#define GC9A01_ENABLE_BACKLIGHT_CONTROL CONFIG_LVGL_ENABLE_BACKLIGHT_CONTROL
...
#define GC9A01_INVERT_COLORS CONFIG_LVGL_INVERT_COLORS
