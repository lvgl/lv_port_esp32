...
#if defined (CONFIG_LVGL_TFT_USE_CUSTOM_SPI_FREQUENCY)
#define SPI_TFT_CLOCK_SPEED_HZ (CONFIG_LVGL_TFT_SPI_CUSTOM_FREQUENCY * 1000 * 1000)
#else
...
#else
#define SPI_TFT_CLOCK_SPEED_HZ  (64*1000*1000)
#endif
