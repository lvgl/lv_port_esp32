...
#define DISP_BUF_SIZE  (CONFIG_LV_HOR_RES_MAX*CONFIG_LV_VER_RES_MAX)
...
#define DISP_BUF_SIZE (CONFIG_LV_VER_RES_MAX * IL3820_COLUMNS)
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_RA8875
#define DISP_BUF_SIZE  (LV_HOR_RES_MAX * 40)
#elif defined (CONFIG_LV_TFT_DISPLAY_CONTROLLER_GC9A01)
#define DISP_BUF_SIZE  (LV_HOR_RES_MAX * 40)
#elif defined (CONFIG_LV_TFT_DISPLAY_CONTROLLER_JD79653A)
#define DISP_BUF_SIZE ((CONFIG_LV_VER_RES_MAX * CONFIG_LV_HOR_RES_MAX) / 8) // 5KB
#elif defined (CONFIG_LV_TFT_DISPLAY_CONTROLLER_UC8151D)
#define DISP_BUF_SIZE ((CONFIG_LV_VER_RES_MAX * CONFIG_LV_HOR_RES_MAX) / 8) // 2888 bytes
#else
